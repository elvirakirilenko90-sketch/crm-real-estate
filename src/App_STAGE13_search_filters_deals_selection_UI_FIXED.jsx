...
function Properties({properties,setProperties,onOpen,users,currentProfile,lang}) {
  ...
  async function createSelection(){
    ...
    const url=uploaded?.publicUrl || localUrl;
    setSelectionUrl(url);
  ...
  return <main className="screen">
    ...
    {selectionUrl && <div className="card selectionBar"><div className="grid3">
      ...
      <a className="btn primary full" href={selectionDownloadUrl||selectionUrl} download={`CRM-selection-${new Date().toISOString().slice(0,10)}.html`}>{tr(lang,"Скачать подборку")}</a>
