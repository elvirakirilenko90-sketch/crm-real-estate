...
function Properties({properties,setProperties,onOpen,users,currentProfile,lang,agencyName,theme,leads}) {
  ...
  return <main className="screen">
    ...
    {selectionUrl && <div className="card selectionBar">
      ...
      <div className="grid4">
        <Button className="full" onClick={()=>openWhatsAppPresentation({phone:selectionClientPhone,url:selectionUrl,lang:selectionLang,agencyName,clientName:selectionClient,isSelection:true})}>WhatsApp</Button>
        <Button className="full" variant="soft" onClick={()=>openEmailPresentation({email:selectionClientEmail,url:selectionUrl,lang:selectionLang,agencyName,clientName:selectionClient,isSelection:true})}>Email</Button>
        <Button className="full" variant="soft" onClick={()=>nativeSharePresentation({url:selectionUrl,downloadUrl:selectionDownloadUrl,lang:selectionLang,agencyName,clientName:selectionClient,isSelection:true})}>Поделиться</Button>
...
function PropertyModal({property,setProperties,onClose,users,currentProfile,role,lang,agencyName,theme,leads}) {
    ...
    <div className="card amber">
      ...
      {presentationUrl && <div style={{marginTop:12}}>
        <div className="card" style={{padding:12,marginBottom:10}}>
          ...
          <div className="grid4">
            <Button className="full" onClick={()=>openWhatsAppPresentation({phone:presentationClientPhone,url:presentationUrl,lang:presentationLang,agencyName,clientName:presentationClient,title:local.title,isSelection:false})}>WhatsApp</Button>
            <Button className="full" variant="soft" onClick={()=>openEmailPresentation({email:presentationClientEmail,url:presentationUrl,lang:presentationLang,agencyName,clientName:presentationClient,title:local.title,isSelection:false})}>Email</Button>
            <Button className="full" variant="soft" onClick={()=>nativeSharePresentation({url:presentationUrl,downloadUrl:presentationUrl,lang:presentationLang,agencyName,clientName:presentationClient,title:local.title,isSelection:false})}>Поделиться</Button>
  ...
  return <div className="layout" data-theme={theme} style={themeStyle(theme)}><style>{globalThemeCss(theme)}</style>
    ...
    <div className="mainWrap">
      <main className="main">
        ...
        {page==="properties"&&<Properties properties={properties} setProperties={setProperties} onOpen={setProperty} users={users} currentProfile={currentProfile} lang={lang} agencyName={agencyName} theme={theme} leads={visibleLeads}/>}  
        ...
        {property&&<PropertyModal property={property} setProperties={setProperties} onClose={()=>setProperty(null)} users={users} currentProfile={currentProfile} role={role} lang={lang} agencyName={agencyName} theme={theme} leads={visibleLeads}/>}  
      </main>
    </div>
  </div>;
}
