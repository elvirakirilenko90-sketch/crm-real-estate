...
function globalThemeCss(themeId){
  ...
  return `
    ...
    .card,.sheet,.kanbanCol,.lead,.modal .sheet,.event{background:${card}!important;color:${text}!important;border-color:color-mix(in srgb, ${accent} 24%, #e5e7eb)!important;box-shadow:0 18px 50px rgba(0,0,0,.08)!important;}
