...
function More({role,setRole,setPage,theme,setTheme,leads,setLeads,users,currentProfile,onLogout}) {
  const isTech = role === "Администратор тех отдел";
...
export default function App(){
  ...
  function isMyLead(item){
    ...
    // По твоему правилу обычный менеджер и директор видят только своих клиентов.
  ...
  return <div className="layout" style={themeStyle(theme)}>
    ...
    <div className="mainWrap">
      <main className="main">
        ...
        {page==="clients"&&<Clients leads={visibleLeads} setLeads={setLeads} onOpen={setLead}/>} 
        ...
        {page==="analytics"&&<Analytics leads={visibleLeads} properties={properties} events={visibleEvents} role={role}/>} 
        ...
        {page==="more"&&<More role={role} setRole={setRole} setPage={setPage} theme={theme} setTheme={setTheme} leads={leads} setLeads={setLeads} users={users} currentProfile={currentProfile} onLogout={signOut}/>} 
