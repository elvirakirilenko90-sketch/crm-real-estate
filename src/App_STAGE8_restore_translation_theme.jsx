...
const TRANSLATE_FALLBACKS = {
  uk: {
    "CRM Real Estate":"CRM Real Estate", "Premium SaaS":"Premium SaaS", "Администратор директор":"Адміністратор директор", "Администратор тех отдел":"Адміністратор тех відділ", "Менеджер по продажам":"Менеджер з продажу",
    "Лента":"Стрічка", "Лента новостей":"Стрічка новин", "Канбан и клиенты":"Канбан і клієнти", "Клиенты":"Клієнти", "Календарь":"Календар", "Вторичка":"Вторинна нерухомість", "Вторичная недвижимость":"Вторинна нерухомість", "Объекты":"Об'єкти", "Аналитика":"Аналітика", "Помощь менеджерам":"Допомога менеджерам", "Доступы":"Доступи", "Еще":"Ще", "Ещё":"Ще",
    "Поиск по CRM...":"Пошук по CRM...", "Загрузка доступа...":"Завантаження доступу...", "Войти":"Увійти", "Входим...":"Входимо...", "Выйти":"Вийти", "Пароль":"Пароль", "Вход в CRM Real Estate":"Вхід у CRM Real Estate", "Введи email и пароль":"Введи email і пароль",
    "Новая публикация":"Нова публікація", "+ Новая публикация":"+ Нова публікація", "Текст публикации...":"Текст публікації...", "Опубликовать":"Опублікувати", "Фото":"Фото", "Видео":"Відео", "Файл":"Файл", "Ссылка":"Посилання", "Вставьте ссылку":"Вставте посилання", "Открыть ссылку":"Відкрити посилання", "Редактировать публикацию":"Редагувати публікацію", "Сохранить изменения":"Зберегти зміни", "Написать комментарий...":"Написати коментар...", "Комментарий":"Коментар", "Удалить публикацию?":"Видалити публікацію?", "Ошибка сохранения публикации:":"Помилка збереження публікації:", "Ошибка загрузки файла:":"Помилка завантаження файлу:",
    "Создать клиента":"Створити клієнта", "+ Создать клиента":"+ Створити клієнта", "Сохранить клиента":"Зберегти клієнта", "Имя клиента":"Ім'я клієнта", "Телефон":"Телефон", "Источник":"Джерело", "Статус":"Статус", "Следующий контакт":"Наступний контакт", "Ответственный менеджер":"Відповідальний менеджер", "Заметки менеджера":"Нотатки менеджера", "История работы с клиентом":"Історія роботи з клієнтом", "Добавить комментарий в историю":"Додати коментар в історію", "Связь с клиентом":"Зв'язок з клієнтом", "Позвонить":"Подзвонити", "Следующий этап":"Наступний етап", "Следующий этап →":"Наступний етап →", "Все":"Усі", "Все менеджеры":"Усі менеджери", "Без имени":"Без імені", "Без заметки":"Без нотатки", "не назначен":"не призначено", "Ответственный":"Відповідальний", "Вопрос директору":"Питання директору", "Задать вопрос директору":"Поставити питання директору", "Ответ директора":"Відповідь директора", "Ожидает ответа":"Очікує відповіді", "Отвечено":"Відповідь надано",
    "Новый Лид":"Новий лід", "Первый контакт":"Перший контакт", "В работе":"У роботі", "Назначена встреча":"Призначена зустріч", "Проведена встреча":"Зустріч проведено", "Думает":"Думає", "Задаток":"Завдаток", "Сделка":"Угода", "Отказ":"Відмова", "Отложили":"Відклали",
    "Звонок":"Дзвінок", "Встреча":"Зустріч", "Показ":"Показ", "Задача":"Завдання", "Год":"Рік", "Месяц":"Місяць", "Неделя":"Тиждень", "День":"День", "Январь":"Січень", "Февраль":"Лютий", "Март":"Березень", "Апрель":"Квітень", "Май":"Травень", "Июнь":"Червень", "Июль":"Липень", "Август":"Серпень", "Сентябрь":"Вересень", "Октябрь":"Жовтень", "Ноябрь":"Листопад", "Декабрь":"Грудень", "Пн":"Пн", "Вт":"Вт", "Ср":"Ср", "Чт":"Чт", "Пт":"Пт", "Сб":"Сб", "Вс":"Нд", "Дата следующего касания":"Дата наступного контакту", "Время":"Час", "Название":"Назва", "Напомнить за":"Нагадати за", "Звук":"Звук", "Сохранить событие":"Зберегти подію", "Проверить звук":"Перевірити звук", "добавить событие":"додати подію", "событий":"подій", "Удалить событие?":"Видалити подію?",
    "Добавить объект":"Додати об'єкт", "+ Добавить объект":"+ Додати об'єкт", "Название объекта":"Назва об'єкта", "Тип":"Тип", "Район":"Район", "Цена":"Ціна", "Площадь":"Площа", "Этаж":"Поверх", "Собственник":"Власник", "Телефон собственника":"Телефон власника", "Описание":"Опис", "Описание украинское":"Опис українською", "Сохранить объект":"Зберегти об'єкт", "Удалить объект":"Видалити об'єкт", "Фото / видео объекта":"Фото / відео об'єкта", "Добавить фото/видео":"Додати фото/відео", "Юридические параметры":"Юридичні параметри", "Право собственности":"Право власності", "Переуступка":"Переуступка", "Госпрограммы":"Держпрограми", "Опубликовать в OLX":"Опублікувати в OLX", "Презентация для клиента":"Презентація для клієнта", "Русская презентация":"Російська презентація", "Українська презентация":"Українська презентація", "Отправить презентацию клиенту":"Надіслати презентацію клієнту", "Скачать PDF-презентацию":"Завантажити PDF-презентацію", "Скопировать ссылку клиенту":"Скопіювати посилання клієнту", "Открыть PDF-презентацию":"Відкрити PDF-презентацію", "Актуален":"Актуальний", "Актуально":"Актуально",
    "Лиды":"Ліди", "Сделки":"Угоди", "События":"Події", "Звонки":"Дзвінки", "Встречи":"Зустрічі", "Показы":"Покази", "Задачи":"Завдання", "Конверсия":"Конверсія", "Воронка клиентов":"Воронка клієнтів", "Фильтр по менеджеру":"Фільтр за менеджером",
    "Создать агентство":"Створити агентство", "Открыть доступ пользователю":"Відкрити доступ користувачу", "Создать доступ":"Створити доступ", "Удалить пользователя":"Видалити користувача", "Удалить агентство":"Видалити агентство", "Редактировать доступ":"Редагувати доступ", "Забрать доступ":"Забрати доступ", "Доступ создан":"Доступ створено", "Доступ активен":"Доступ активний",
    "Язык интерфейса":"Мова інтерфейсу", "Цветовая гамма CRM":"Кольорова гама CRM", "Каждый пользователь может выбрать оформление под себя.":"Кожен користувач може обрати оформлення під себе.", "Роль для проверки CRM":"Роль для перевірки CRM", "Русский":"Російська", "Українська":"Українська", "English":"English", "Загрузка клиентов из файла":"Завантаження клієнтів з файлу", "Загрузить клиентов и назначить менеджера":"Завантажити клієнтів і призначити менеджера", "Создать и назначить клиента":"Створити і призначити клієнта",
    "Редактировать":"Редагувати", "Удалить":"Видалити", "Открыть":"Відкрити", "Закрыть":"Закрити", "Сохранить":"Зберегти", "Отправить":"Надіслати", "Добавить":"Додати", "Выбери менеджера":"Вибери менеджера", "Ошибка":"Помилка", "Ошибка сохранения объекта:":"Помилка збереження об'єкта:", "Ошибка создания объекта:":"Помилка створення об'єкта:", "Ошибка сохранения клиента:":"Помилка збереження клієнта:", "Ошибка создания клиента:":"Помилка створення клієнта:"
  },
  en: {
    "Администратор директор":"Director admin", "Администратор тех отдел":"Technical admin", "Менеджер по продажам":"Sales manager", "Лента":"Feed", "Лента новостей":"News Feed", "Канбан и клиенты":"Kanban and Clients", "Клиенты":"Clients", "Календарь":"Calendar", "Вторичка":"Resale", "Вторичная недвижимость":"Resale Properties", "Объекты":"Properties", "Аналитика":"Analytics", "Помощь менеджерам":"Manager Help", "Доступы":"Access", "Еще":"More", "Ещё":"More", "Поиск по CRM...":"Search CRM...", "Загрузка доступа...":"Loading access...", "Войти":"Sign in", "Входим...":"Signing in...", "Выйти":"Sign out", "Пароль":"Password", "Вход в CRM Real Estate":"CRM Real Estate Login", "Введи email и пароль":"Enter email and password",
    "Новая публикация":"New post", "+ Новая публикация":"+ New post", "Текст публикации...":"Post text...", "Опубликовать":"Publish", "Фото":"Photo", "Видео":"Video", "Файл":"File", "Ссылка":"Link", "Вставьте ссылку":"Paste link", "Открыть ссылку":"Open link", "Редактировать публикацию":"Edit post", "Сохранить изменения":"Save changes", "Написать комментарий...":"Write a comment...", "Комментарий":"Comment",
    "Создать клиента":"Create client", "+ Создать клиента":"+ Create client", "Сохранить клиента":"Save client", "Имя клиента":"Client name", "Телефон":"Phone", "Источник":"Source", "Статус":"Status", "Следующий контакт":"Next contact", "Ответственный менеджер":"Responsible manager", "Заметки менеджера":"Manager notes", "История работы с клиентом":"Client history", "Добавить комментарий в историю":"Add comment to history", "Связь с клиентом":"Contact client", "Позвонить":"Call", "Следующий этап":"Next stage", "Следующий этап →":"Next stage →", "Все":"All", "Все менеджеры":"All managers", "Без имени":"No name", "Без заметки":"No note", "не назначен":"not assigned", "Ответственный":"Responsible", "Вопрос директору":"Question to director", "Задать вопрос директору":"Ask director", "Ответ директора":"Director reply", "Ожидает ответа":"Waiting for reply", "Отвечено":"Answered",
    "Новый Лид":"New Lead", "Первый контакт":"First Contact", "В работе":"In Progress", "Назначена встреча":"Meeting Set", "Проведена встреча":"Meeting Done", "Думает":"Thinking", "Задаток":"Deposit", "Сделка":"Deal", "Отказ":"Refusal", "Отложили":"Postponed",
    "Звонок":"Call", "Встреча":"Meeting", "Показ":"Showing", "Задача":"Task", "Год":"Year", "Месяц":"Month", "Неделя":"Week", "День":"Day", "Январь":"January", "Февраль":"February", "Март":"March", "Апрель":"April", "Май":"May", "Июнь":"June", "Июль":"July", "Август":"August", "Сентябрь":"September", "Октябрь":"October", "Ноябрь":"November", "Декабрь":"December", "Пн":"Mon", "Вт":"Tue", "Ср":"Wed", "Чт":"Thu", "Пт":"Fri", "Сб":"Sat", "Вс":"Sun", "Дата следующего касания":"Next touch date", "Время":"Time", "Название":"Title", "Напомнить за":"Remind before", "Звук":"Sound", "Сохранить событие":"Save event", "Проверить звук":"Test sound", "добавить событие":"add event", "событий":"events", "Удалить событие?":"Delete event?",
    "Добавить объект":"Add property", "+ Добавить объект":"+ Add property", "Название объекта":"Property title", "Тип":"Type", "Район":"District", "Цена":"Price", "Площадь":"Area", "Этаж":"Floor", "Собственник":"Owner", "Телефон собственника":"Owner phone", "Описание":"Description", "Описание украинское":"Ukrainian description", "Сохранить объект":"Save property", "Удалить объект":"Delete property", "Фото / видео объекта":"Property photo/video", "Добавить фото/видео":"Add photo/video", "Юридические параметры":"Legal parameters", "Право собственности":"Ownership right", "Переуступка":"Assignment", "Госпрограммы":"Government programs", "Опубликовать в OLX":"Publish to OLX", "Презентация для клиента":"Client presentation", "Русская презентация":"Russian presentation", "Українська презентация":"Ukrainian presentation", "Отправить презентацию клиенту":"Send presentation to client", "Скачать PDF-презентацию":"Download PDF presentation", "Скопировать ссылку клиенту":"Copy client link", "Открыть PDF-презентацию":"Open PDF presentation", "Актуален":"Active", "Актуально":"Active",
    "Лиды":"Leads", "Сделки":"Deals", "События":"Events", "Звонки":"Calls", "Встречи":"Meetings", "Показы":"Showings", "Задачи":"Tasks", "Конверсия":"Conversion", "Воронка клиентов":"Client funnel", "Фильтр по менеджеру":"Manager filter",
    "Создать агентство":"Create agency", "Открыть доступ пользователю":"Open user access", "Создать доступ":"Create access", "Удалить пользователя":"Delete user", "Удалить агентство":"Delete agency", "Редактировать доступ":"Edit access", "Забрать доступ":"Remove access", "Доступ создан":"Access created", "Доступ активен":"Access active",
    "Язык интерфейса":"Interface language", "Цветовая гамма CRM":"CRM color theme", "Каждый пользователь может выбрать оформление под себя.":"Each user can choose their own interface style.", "Роль для проверки CRM":"Role for CRM testing", "Русский":"Russian", "Українська":"Ukrainian", "English":"English", "Загрузка клиентов из файла":"Client file import", "Загрузить клиентов и назначить менеджера":"Upload clients and assign manager", "Создать и назначить клиента":"Create and assign client",
    "Редактировать":"Edit", "Удалить":"Delete", "Открыть":"Open", "Закрыть":"Close", "Сохранить":"Save", "Отправить":"Send", "Добавить":"Add", "Выбери менеджера":"Choose manager", "Ошибка":"Error", "Ошибка сохранения объекта:":"Property save error:", "Ошибка создания объекта:":"Property creation error:", "Ошибка сохранения клиента:":"Client save error:", "Ошибка создания клиента:":"Client creation error:"
  }
};
translations.uk = {...(translations.uk || {}), ...TRANSLATE_FALLBACKS.uk};
translations.en = {...(translations.en || {}), ...TRANSLATE_FALLBACKS.en};

function localizedStaticText(value, lang){
  if (!lang || lang === "ru") return value;
  const dict = translations[lang] || {};
  const allDicts = [translations.uk || {}, translations.en || {}];
  ...
  for (const d of allDicts) {
    for (const [ru, translated] of Object.entries(d)) {
      if (trimmed === translated) { canonical = ru; break; }
    }
    if (canonical !== trimmed) break;
  }
  return before + (dict[canonical] || dict[trimmed] || canonical) + after;
}

function translateDomOnce(lang){
  ...
  const walker = document.createTreeWalker(root, NodeFilter.SHOW_TEXT, {
    acceptNode(node){
      ...
      if (parent.closest("input, textarea, [data-no-translate]")) return NodeFilter.FILTER_REJECT;
      const txt = node.nodeValue || "";
      if (!txt.trim()) return NodeFilter.FILTER_REJECT;
      const translated = localizedStaticText(txt, lang);
      return translated !== txt ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT;
    }
  });
  const nodes=[];
  while(walker.nextNode()) nodes.push(walker.currentNode);
  nodes.forEach(n => { n.nodeValue = localizedStaticText(n.nodeValue, lang); });
  root.querySelectorAll("input[placeholder], textarea[placeholder]").forEach(el => {
    const p = el.getAttribute("placeholder");
    const next = localizedStaticText(p, lang);
    if (next !== p) el.setAttribute("placeholder", next);
  });
  root.querySelectorAll("option").forEach(el => {
    const txt = el.textContent;
    const next = localizedStaticText(txt, lang);
    if (next !== txt) el.textContent = next;
  });
}

function CrmThemeCss(){
  return <style>{`
    .layout{
      background: linear-gradient(135deg, var(--soft), #ffffff) !important;
      color: var(--text) !important;
    }
    .sidebar, .top, .card.dark, .logo, .roleBox{
      background: var(--dark) !important;
      border-color: color-mix(in srgb, var(--accent) 28%, transparent) !important;
    }
    .mainWrap, .main, .screen{
      background: transparent !important;
    }
    .card, .sheet, .composer, .post, .lead, .kanbanCol, .day, .weekRow, .monthBox, .event, .comments, .field, .input, input, textarea, select{
      background: var(--card) !important;
      color: var(--text) !important;
      border-color: color-mix(in srgb, var(--accent) 18%, #e5e7eb) !important;
    }
    .lead, .post, .event, .kanbanCol, .monthBox, .weekRow, .day{
      box-shadow: 0 12px 30px color-mix(in srgb, var(--accent) 10%, transparent) !important;
    }
    .btn.primary, button.btn.primary, .sideBtn.active, .bottom button.active, .agencyTop, .badge.gold, .chip:hover{
      background: var(--accent) !important;
      color: #111827 !important;
      border-color: var(--accent) !important;
    }
    .btn.soft, button.btn.soft, .chip, .badge{
      background: color-mix(in srgb, var(--accent2) 18%, #ffffff) !important;
      color: var(--text) !important;
      border-color: color-mix(in srgb, var(--accent) 22%, transparent) !important;
    }
    .btn.green{ background: color-mix(in srgb, #10b981 75%, var(--accent) 25%) !important; color:#fff !important; }
    .btn.purple{ background: color-mix(in srgb, #7c3aed 75%, var(--accent) 25%) !important; color:#fff !important; }
    .amber{ background: color-mix(in srgb, var(--accent2) 24%, #ffffff) !important; }
    .media{ background: linear-gradient(135deg, color-mix(in srgb, var(--dark) 76%, #ffffff), var(--accent)) !important; }
    .search, .search input{
      background: color-mix(in srgb, var(--dark) 84%, #ffffff) !important;
      color: #fff !important;
    }
    .muted, .mutedDay{ color: color-mix(in srgb, var(--text) 58%, #9ca3af) !important; }
    a, .link{ color: var(--accent) !important; }
    .bottom{ background: color-mix(in srgb, var(--card) 92%, transparent) !important; }
  `}</style>;
}
...
function PropertyModal({property,setProperties,onClose,users,currentProfile,role,lang}) {
  ...
  const isResponsibleManager = Boolean(currentManagerEmail) && String(responsibleEmail || "") === String(currentManagerEmail);
  const canEditProperty = isTech || isNewProperty || isResponsibleManager;
  const canEditLegal = isTech || isResponsibleManager || isNewProperty;
  ...
  async function generateClientPresentation(){
    const isUkPresentation = presentationLang === "uk";
    const pdfText = {
      titleFallback: isUkPresentation ? "Презентація об'єкта" : "Презентация объекта",
      infoTitle: isUkPresentation ? "Інформація про об'єкт" : "Информация об объекте",
      type: isUkPresentation ? "Тип" : "Тип",
      district: isUkPresentation ? "Район" : "Район",
      status: isUkPresentation ? "Статус" : "Статус",
      price: isUkPresentation ? "Ціна" : "Цена",
      area: isUkPresentation ? "Площа" : "Площадь",
      floor: isUkPresentation ? "Поверх" : "Этаж",
      description: isUkPresentation ? "Опис" : "Описание",
      noDescription: isUkPresentation ? "Опис об'єкта не додано." : "Описание объекта не добавлено.",
      privacy: isUkPresentation ? "Документ сформовано без персональних даних: власник, телефон власника та відповідальний менеджер не вказані." : "Документ сформирован без персональных данных: собственник, телефон собственника и ответственный менеджер не указаны.",
      photoFallback: isUkPresentation ? "Фото не вдалося вбудувати в PDF, але воно доступне в картці об'єкта." : "Фото не удалось встроить в PDF, но оно доступно в карточке объекта."
    };
    const presentationDescription = isUkPresentation ? (local.description_uk || local.description || "") : (local.description || "");
    ...
    drawWrapped(ctx, local.title || pdfText.titleFallback, 90, 145, 1060, 58);

    let y = 270;
    ctx.fillStyle = "#111827";
    ctx.font = "bold 38px Arial";
    ctx.fillText(pdfText.infoTitle, 90, y);
    y += 60;

    const rows = [
      [pdfText.type, local.type || "—"],
      [pdfText.district, local.district || "—"],
      [pdfText.status, local.status || "—"],
      [pdfText.price, money(local.price)],
      [pdfText.area, `${local.area || 0} м²`],
      [pdfText.floor, local.floor || "—"]
    ];
    ...
    ctx.fillText(pdfText.description, 90, y);
    y += 45;
    ctx.font = "26px Arial";
    ctx.fillStyle = "#374151";
    y = drawWrapped(ctx, presentationDescription || pdfText.noDescription, 90, y, 1060, 38);

    y += 30;
    ctx.fillStyle = "#b45309";
    ctx.font = "bold 24px Arial";
    drawWrapped(ctx, pdfText.privacy, 90, y, 1060, 34);
    ...
    for (const m of imageMedia){
      ...
      x.fillText(local.title || pdfText.titleFallback, 90, 82);
      if (loaded){
        ...
        x.fillStyle = "#374151";
        x.font = "28px Arial";
        drawWrapped(x, pdfText.photoFallback, 90, 300, 1060, 40);
      }
  ...
  return <Modal onClose={onClose} wide>
    ...
    {!canEditProperty && <div className="card amber"><b>Режим просмотра.</b><p className="muted">Редактировать этот объект может только ответственный менеджер или администратор тех отдела. Ты можешь смотреть объект, связаться с ответственным менеджером и отправить презентацию клиенту.</p></div>}
    ...
    <div className="grid2"><Button className="full" onClick={save} disabled={!canEditProperty}>Сохранить объект</Button><Button className="full" variant="soft" disabled={!canEditProperty} onClick={()=>{setLocal({...local,olx_status:"pending"}); alert("Заявка на публикацию в OLX отправлена тех отделу");}}>Опубликовать в OLX</Button></div>{local.olx_status === "pending" && isTech && <Button className="full" onClick={()=>{setLocal({...local,olx_status:"approved"}); alert("Тех отдел подтвердил публикацию. Для реальной публикации нужен OLX API токен.");}}>Подтвердить публикацию OLX</Button>}
    ...
    <div className="card amber">
      ...
      <div className="grid2" style={{marginBottom:12}}>
        <Button variant={presentationLang === "ru" ? "primary" : "soft"} onClick={()=>setPresentationLang("ru")}>Русская презентация</Button>
        <Button variant={presentationLang === "uk" ? "primary" : "soft"} onClick={()=>setPresentationLang("uk")}>Українська презентація</Button>
      </div>
...
export default function App(){
  ...
  useEffect(() => {
    translateDomOnce(lang);
    if (lang === "ru") return;
    const observer = new MutationObserver(() => translateDomOnce(lang));
