...
const MARKET_OFFICIAL_ODESSA_DISTRICTS=["Киевский","Приморский","Хаджибейский","Пересыпский"];
const MARKET_GEO_CATALOG={
  "Украина":{
    regions:["Винницкая область","Волынская область","Днепропетровская область","Донецкая область","Житомирская область","Закарпатская область","Запорожская область","Ивано-Франковская область","Киевская область","Кировоградская область","Луганская область","Львовская область","Николаевская область","Одесская область","Полтавская область","Ровненская область","Сумская область","Тернопольская область","Харьковская область","Херсонская область","Хмельницкая область","Черкасская область","Черновицкая область","Черниговская область","Автономная Республика Крым","Киев","Севастополь"],
    cities:["Киев","Одесса","Львов","Харьков","Днепр","Запорожье","Винница","Ивано-Франковск","Ужгород","Черновцы","Хмельницкий","Тернополь","Ровно","Луцк","Житомир","Полтава","Черкассы","Чернигов","Сумы","Кропивницкий","Николаев","Херсон","Кривой Рог","Каменское","Белая Церковь","Бровары","Буча","Ирпень","Борисполь","Мукачево","Дрогобыч","Трускавец","Стрый","Коломыя","Яремче"]
  },
  "Грузия":{regions:["Тбилиси","Аджария","Имеретия","Кахетия","Мцхета-Мтианети","Самегрело-Земо-Сванети","Самцхе-Джавахети","Шида-Картли","Квемо-Картли","Гурия","Рача-Лечхуми и Квемо-Сванети","Абхазия"],cities:["Тбилиси","Батуми","Кутаиси","Рустави","Кобулети","Гудаури","Бакуриани","Боржоми","Телави","Зугдиди","Поти"]},
  "ОАЭ":{regions:["Dubai","Abu Dhabi","Sharjah","Ajman","Ras Al Khaimah","Fujairah","Umm Al Quwain"],cities:["Dubai","Abu Dhabi","Sharjah","Ajman","Ras Al Khaimah","Fujairah","Al Ain","Umm Al Quwain"]},
  "Испания":{regions:["Andalusia","Aragon","Asturias","Balearic Islands","Basque Country","Canary Islands","Cantabria","Castile and León","Castilla-La Mancha","Catalonia","Extremadura","Galicia","La Rioja","Madrid","Murcia","Navarre","Valencian Community"],cities:["Madrid","Barcelona","Valencia","Alicante","Malaga","Marbella","Seville","Bilbao","Palma","Murcia","Granada","Las Palmas de Gran Canaria","Santa Cruz de Tenerife"]},
  "Португалия":{regions:["Lisboa","Porto","Algarve","Madeira","Azores","Braga","Aveiro","Setúbal","Leiria","Coimbra","Faro"],cities:["Lisbon","Porto","Braga","Faro","Albufeira","Cascais","Funchal","Coimbra","Aveiro","Setúbal"]},
  "Италия":{regions:["Lombardy","Lazio","Tuscany","Sicily","Veneto","Piedmont","Liguria","Emilia-Romagna","Campania","Sardinia","Puglia"],cities:["Rome","Milan","Turin","Florence","Naples","Bologna","Venice","Genoa","Palermo","Bari"]},
  "Германия":{regions:["Berlin","Bavaria","North Rhine-Westphalia","Baden-Württemberg","Hesse","Hamburg","Saxony","Lower Saxony","Brandenburg"],cities:["Berlin","Munich","Hamburg","Frankfurt","Cologne","Düsseldorf","Stuttgart","Leipzig","Dresden"]},
  "Франция":{regions:["Île-de-France","Provence-Alpes-Côte d’Azur","Auvergne-Rhône-Alpes","Occitanie","Nouvelle-Aquitaine","Brittany","Normandy","Grand Est"],cities:["Paris","Nice","Cannes","Marseille","Lyon","Bordeaux","Toulouse","Montpellier","Nantes","Strasbourg"]},
  "Польша":{regions:["Dolnośląskie","Kujawsko-Pomorskie","Łódzkie","Lubelskie","Lubuskie","Małopolskie","Mazowieckie","Opolskie","Podkarpackie","Podlaskie","Pomorskie","Śląskie","Świętokrzyskie","Warmińsko-Mazurskie","Wielkopolskie","Zachodniopomorskie"],cities:["Warsaw","Kraków","Wrocław","Gdańsk","Poznań","Łódź","Szczecin","Katowice","Lublin"]},
  "Великобритания":{regions:["England","Scotland","Wales","Northern Ireland"],cities:["London","Manchester","Birmingham","Liverpool","Leeds","Bristol","Edinburgh","Glasgow","Cardiff","Belfast"]},
  "Таиланд":{regions:["Bangkok","Phuket","Chon Buri","Chiang Mai","Prachuap Khiri Khan","Surat Thani","Krabi","Phangnga"],cities:["Bangkok","Phuket","Pattaya","Chiang Mai","Hua Hin","Koh Samui","Krabi"]},
  "Индонезия":{regions:["Bali","Jakarta","West Java","East Java","Banten","Central Java","Yogyakarta"],cities:["Denpasar","Canggu","Seminyak","Ubud","Kuta","Sanur","Jakarta","Surabaya","Bandung"]},
  "Кипр":{regions:["Nicosia","Limassol","Larnaca","Paphos","Famagusta"],cities:["Nicosia","Limassol","Larnaca","Paphos","Ayia Napa","Paralimni"]},
  "США":{regions:["California","Florida","New York","Texas","Arizona","Nevada","Georgia","Washington","Illinois","Colorado"],cities:["New York","Los Angeles","Miami","Orlando","Tampa","Chicago","Houston","Dallas","Austin","Phoenix","Las Vegas","San Francisco","Seattle"]},
  "Канада":{regions:["Ontario","British Columbia","Quebec","Alberta","Manitoba","Nova Scotia"],cities:["Toronto","Vancouver","Montreal","Calgary","Ottawa","Edmonton","Victoria","Halifax"]}
};
const MARKET_SOURCE_CATALOG=[
  {country:"Украина",name:"DIM.RIA",aliases:["DOM.RIA","DIM RIA","DOM RIA","DIM.RIA Украина","DOM.RIA Украина"],url:"https://dom.ria.com/prodazha-nedvizhimosti/"},
  {country:"Украина",name:"OLX Украина",aliases:["OLX","OLX.ua","ОЛХ"],url:"https://www.olx.ua/uk/nedvizhimost/"},
  {country:"Украина",name:"RIELTOR.UA",aliases:["Rieltor","RIELTOR","rieltor.ua"],url:"https://rieltor.ua/"},
  {country:"Украина",name:"REM.ua",aliases:["REM","Rem.UA","rem.ua"],url:"https://rem.ua/ua"},
  {country:"Украина",name:"LUN",aliases:["ЛУН","LUN.ua","lun.ua"],url:"https://lun.ua/"},
  {country:"Грузия",name:"MyHome.ge",aliases:["MyHome","myhome.ge"],url:"https://www.myhome.ge/en/"},
  {country:"Грузия",name:"SS.ge",aliases:["SS","ss.ge"],url:"https://home.ss.ge/en/real-estate"},
  {country:"ОАЭ",name:"Bayut",aliases:["bayut.com"],url:"https://www.bayut.com/for-sale/property/uae/"},
  {country:"ОАЭ",name:"Property Finder UAE",aliases:["Property Finder","propertyfinder.ae"],url:"https://www.propertyfinder.ae/en/buy/properties-for-sale.html"},
  {country:"Испания",name:"idealista Spain",aliases:["Idealista Spain","idealista.com"],url:"https://www.idealista.com/en/properties-for-sale-in-spain"},
  {country:"Португалия",name:"idealista Portugal",aliases:["Idealista Portugal","idealista.pt"],url:"https://www.idealista.pt/properties-for-sale-in-portugal"},
  {country:"Италия",name:"Immobiliare.it",aliases:["Immobiliare","immobiliare.it"],url:"https://www.immobiliare.it/"},
  {country:"Германия",name:"ImmoScout24",aliases:["ImmobilienScout24","immobilienscout24.de"],url:"https://www.immobilienscout24.de/"},
  {country:"Франция",name:"SeLoger",aliases:["seloger.com"],url:"https://www.seloger.com/"},
  {country:"Польша",name:"Otodom",aliases:["otodom.pl"],url:"https://www.otodom.pl/pl/wyniki/sprzedaz/mieszkanie"},
  {country:"Великобритания",name:"Rightmove",aliases:["rightmove.co.uk"],url:"https://www.rightmove.co.uk/property-for-sale.html"},
  {country:"Таиланд",name:"FazWaz",aliases:["fazwaz.com","fazwaz.co.th"],url:"https://www.fazwaz.com/property-for-sale/thailand"},
  {country:"Таиланд",name:"DDproperty",aliases:["ddproperty.com"],url:"https://www.ddproperty.com/en/property-for-sale"},
  {country:"Индонезия",name:"Rumah123",aliases:["rumah123.com"],url:"https://www.rumah123.com/en/sale/residential/"},
  {country:"Кипр",name:"Bazaraki",aliases:["bazaraki.com"],url:"https://www.bazaraki.com/real-estate-for-sale/"},
  {country:"США",name:"Zillow",aliases:["zillow.com"],url:"https://www.zillow.com/us/"},
  {country:"Канада",name:"REALTOR.ca",aliases:["realtor.ca"],url:"https://www.realtor.ca/"},
  {country:"Глобальные",name:"Telegram",aliases:["Telegram channel","TELEGRAM"],url:""},
  {country:"Глобальные",name:"CRM",aliases:["Внутренняя CRM"],url:""}
];
const MARKET_COUNTRY_ALIASES={"Україна":"Украина","Ukraine":"Украина","Georgia":"Грузия","საქართველო":"Грузия","UAE":"ОАЭ","United Arab Emirates":"ОАЭ","ОАЭ":"ОАЭ","Spain":"Испания","España":"Испания","Portugal":"Португалия","Italy":"Италия","Italia":"Италия","Germany":"Германия","Deutschland":"Германия","France":"Франция","Poland":"Польша","United Kingdom":"Великобритания","UK":"Великобритания","Thailand":"Таиланд","Indonesia":"Индонезия","Cyprus":"Кипр","United States":"США","USA":"США","Canada":"Канада"};
const MARKET_ODESSA_DISTRICT_ALIASES={"Київський":"Киевский","Киевский":"Киевский","Приморський":"Приморский","Приморский":"Приморский","Хаджибейський":"Хаджибейский","Хаджибейский":"Хаджибейский","Малиновский":"Хаджибейский","Малиновський":"Хаджибейский","Пересипський":"Пересыпский","Пересыпский":"Пересыпский","Суворовский":"Пересыпский","Суворовський":"Пересыпский"};

function Analytics({leads,properties,events,role,users,activities,currentProfile,onOpenProperty,agencyName,theme}) {
  ...
  const [sourceCountryFilter,setSourceCountryFilter]=useState("Все страны");
  const [selectedSources,setSelectedSources]=useState([]);
  const [neighborhoodFilter,setNeighborhoodFilter]=useState("Все");
  ...
  const loadMarket=async()=>{
    ...
    const [{data,error},{data:sourcesData,error:sourcesError}]=await Promise.all([
      supabase.from("market_listings").select("*").eq("agency_id",agencyId).order("last_seen_at",{ascending:false}).limit(2000),
    ...
    if(sourcesError) console.warn("market_sources:",sourcesError); else setMarketSources(sourcesData||[]);
  ...
  const syncMarket=async()=>{
    ...
    try{
      const {data,error}=await supabase.functions.invoke("market-sync",{body:{agency_id:agencyId}});
      if(error)throw error;
      await loadMarket();
      const results=Array.isArray(data?.results)?data.results:[];
      const found=results.reduce((n,x)=>n+Number(x?.listings_found||0),0);
      alert(`Рынок обновлён${found?`. Найдено объявлений: ${found}`:"."}`);
  ...
  const getListingDate=x=>x.published_at||x.last_seen_at||x.first_seen_at||x.created_at||x.updated_at||"";
  ...
  const combinedListings=[...marketListings.map(x=>({...x,_key:`market-${x.id}`,origin:"market"})),...internalMarketListings];
  const normCountry=v=>MARKET_COUNTRY_ALIASES[String(v||"").trim()]||String(v||"").trim();
  const canonicalSource=(name,url="")=>{
    const raw=String(name||"").trim(),u=String(url||"").toLowerCase();
    if(/idealista\.pt/.test(u))return "idealista Portugal";
    if(/idealista\.(com|es)/.test(u))return "idealista Spain";
    for(const item of MARKET_SOURCE_CATALOG){const all=[item.name,...(item.aliases||[])].map(x=>String(x).toLowerCase());if(all.includes(raw.toLowerCase())||all.some(x=>x&&raw.toLowerCase().includes(x)))return item.name;}
    return raw||"Без источника";
  };
  const sourceCountryOf=x=>{
    const own=normCountry(x.country);if(own)return own;
    const source=canonicalSource(x.source_name,x.source_url);
    return MARKET_SOURCE_CATALOG.find(i=>i.name===source)?.country==="Глобальные"?"":(MARKET_SOURCE_CATALOG.find(i=>i.name===source)?.country||"");
  };
  const findCityInText=(text,countryName)=>{
    const list=MARKET_GEO_CATALOG[countryName]?.cities||[];const low=String(text||"").toLowerCase();
    return list.find(c=>low.includes(String(c).toLowerCase()))||"";
  };
  const normalizeGeo=x=>{
    const source_name=canonicalSource(x.source_name,x.source_url);
    const sourceCountry=sourceCountryOf({...x,source_name});
    const countryName=normCountry(x.country)||sourceCountry;
    const searchText=[x.title,x.description,x.source_url,x.raw_data&&JSON.stringify(x.raw_data)].filter(Boolean).join(" ");
    let cityName=String(x.city||"").trim();
    if(cityName==="Одеса")cityName="Одесса";
    if(!cityName&&countryName)cityName=findCityInText(searchText,countryName);
    let regionName=String(x.region||x.oblast||"").trim();
    if(!regionName&&countryName==="Украина"&&cityName==="Одесса")regionName="Одесская область";
    let rawDistrict=String(x.district||"").trim(),districtName=rawDistrict,neighborhood=String(x.neighborhood||x.microdistrict||x.location_name||"").trim();
    if(cityName==="Одесса"){
      const direct=MARKET_ODESSA_DISTRICT_ALIASES[rawDistrict];
      if(direct)districtName=direct;
      else if(rawDistrict){districtName="";if(!neighborhood)neighborhood=rawDistrict;}
      if(!districtName){for(const [variant,official] of Object.entries(MARKET_ODESSA_DISTRICT_ALIASES)){if(searchText.toLowerCase().includes(variant.toLowerCase())){districtName=official;break;}}}
      if(!neighborhood&&/аркади[яї]/i.test(searchText))neighborhood="Аркадия";
    }
    return {...x,country:countryName,region:regionName,city:cityName,district:districtName,neighborhood,source_name,source_country:sourceCountry||countryName};
  };
  const normalizedListings=combinedListings.map(normalizeGeo);
  const observed=(key,items=normalizedListings)=>Array.from(new Set(items.map(x=>String(x?.[key]||"").trim()).filter(Boolean))).sort((a,b)=>a.localeCompare(b,"ru"));
  const countries=["Все",...Array.from(new Set([...Object.keys(MARKET_GEO_CATALOG),...observed("country")]))];
  const countryListings=country==="Все"?normalizedListings:normalizedListings.filter(x=>x.country===country);
  const catalogRegions=country!=="Все"?(MARKET_GEO_CATALOG[country]?.regions||[]):[];
  const catalogCities=country!=="Все"?(MARKET_GEO_CATALOG[country]?.cities||[]):[];
  const regions=["Все",...Array.from(new Set([...catalogRegions,...observed("region",countryListings)]))];
  const cities=["Все",...Array.from(new Set([...catalogCities,...observed("city",countryListings)]))];
  const cityListings=countryListings.filter(x=>city==="Все"||x.city===city);
  const districtsMarket=(country==="Украина"&&city==="Одесса")?["Все",...MARKET_OFFICIAL_ODESSA_DISTRICTS]:["Все",...observed("district",cityListings)];
  const neighborhoods=["Все",...observed("neighborhood",cityListings)];
  const complexes=["Все",...observed("complex_name",cityListings)];
  const catalogSourceCountries=["Все страны",...Object.keys(MARKET_GEO_CATALOG),"Глобальные"];
  const sourceCatalogVisible=MARKET_SOURCE_CATALOG.filter(i=>sourceCountryFilter==="Все страны"||i.country===sourceCountryFilter);
  const connectedSources=new Set((marketSources||[]).filter(x=>x.enabled!==false).map(x=>canonicalSource(x.name,x.endpoint_url)));
  const sourceDataCounts=normalizedListings.reduce((m,x)=>{m[x.source_name]=(m[x.source_name]||0)+1;return m;},{});
  const filtered=normalizedListings.filter(x=>{
    const num=v=>Number(v||0);
    return inMarketPeriod(x)
      &&(country==="Все"||x.country===country)
      &&(region==="Все"||x.region===region)
      &&(city==="Все"||x.city===city)
      &&(districtFilter==="Все"||x.district===districtFilter)
      &&(neighborhoodFilter==="Все"||x.neighborhood===neighborhoodFilter)
      &&(complexFilter==="Все"||String(x.complex_name||"")===complexFilter)
      &&(dealFilter==="Все"||String(x.deal_type||"")===dealFilter)
      &&(selectedSources.length===0||selectedSources.includes(x.source_name))
      &&(roomsFilter==="Все"||(roomsFilter==="4+"?num(x.rooms)>=4:String(num(x.rooms))===roomsFilter))
      &&(!priceFrom||num(x.price)>=num(priceFrom))&&(!priceTo||num(x.price)<=num(priceTo))
      &&(!areaFrom||num(x.area)>=num(areaFrom))&&(!areaTo||num(x.area)<=num(areaTo));
  });

  const activePrices=filtered.map(x=>Number(x.price||0)).filter(x=>x>0);
  const avgPrice=activePrices.length?Math.round(activePrices.reduce((a,b)=>a+b,0)/activePrices.length):0;
  const m2=filtered.map(x=>Number(x.price||0)>0&&Number(x.area||0)>0?Number(x.price)/Number(x.area):0).filter(Boolean);
  ...
  const selectionItems=normalizedListings.filter(x=>selected.includes(String(x._key))).map(x=>{
    const crm=crmMatch(x);
    if(crm)return crm;
  ...
  const copyListing=async x=>{const text=[x.title,x.price?money(x.price):"",x.source_url].filter(Boolean).join(" · ");try{await navigator.clipboard.writeText(text);alert("Данные объявления скопированы.");}catch{alert(text);}};
  const shareListing=async x=>{const data={title:x.title||"Объект недвижимости",text:`${x.title||"Объект"}${x.price?` · ${money(x.price)}`:""}`,url:x.source_url||undefined};if(navigator.share){try{await navigator.share(data);return;}catch{}}await copyListing(x);};
  ...
  const dayGroups=filtered.reduce((m,x)=>{const raw=getListingDate(x);const d=raw?String(raw).slice(0,10):"";if(!d)return m;(m[d]||(m[d]=[])).push(Number(x.price||0));return m;},{});
  ...
  const connectCatalogSource=async item=>{
    if(!agencyId||!item?.url)return;
    if(connectedSources.has(item.name))return alert(`${item.name} уже подключён.`);
    const payload={agency_id:agencyId,name:item.name,country:item.country==="Глобальные"?"":item.country,city:"",source_type:"WEB",connector_key:"web_json_ld",connection_method:"WEB",endpoint_url:item.url,enabled:true,paused:false,sync_mode:"scheduled",auth_type:"none",connection_status:"not_checked",connector_config:{catalog:true},field_mapping:{}};
    const {data,error}=await supabase.from("market_sources").insert(payload).select().single();
    if(error){alert(`Не удалось подключить ${item.name}: ${error.message}`);return;}
    setMarketSources(v=>[data,...v]);alert(`${item.name} добавлен в активные источники. Нажми «Обновить рынок», чтобы проверить получение объявлений.`);
  };
  const toggleSourceFilter=name=>setSelectedSources(v=>v.includes(name)?v.filter(x=>x!==name):[...v,name]);
  const resetFilters=()=>{setPeriod("30");setDateFrom("");setDateTo("");setCountry("Все");setRegion("Все");setCity("Все");setDistrictFilter("Все");setNeighborhoodFilter("Все");setComplexFilter("Все");setDealFilter("Все");setSourceCountryFilter("Все страны");setSelectedSources([]);setRoomsFilter("Все");setPriceFrom("");setPriceTo("");setAreaFrom("");setAreaTo("");};
  ...
  return <main className="screen">
    <div className="card dark" style={{padding:26,borderRadius:24}}>
      <div className="row" style={{alignItems:"center",gap:18}}>
        <section><div style={{fontSize:13,fontWeight:900,letterSpacing:1.8,opacity:.7}}>MARKET INTELLIGENCE</div><h2 style={{fontSize:32,margin:"7px 0"}}>📊 Аналитика рынка</h2><p style={{margin:0}}>Украина • Грузия • Европа • ОАЭ • Азия • США/Канада • CRM</p></section>
    ...
    <div className="card" style={{padding:22,borderRadius:24}}>
      <div className="row"><section><h3 style={{margin:0}}>География рынка</h3><p className="muted" style={{margin:"5px 0 0"}}>Страна → регион → город → официальный район. Для Одессы используются только административные районы города; Аркадия и похожие названия идут как локации/микрорайоны.</p></section></div>
      <div className="grid4" style={{marginTop:14}}>
        <div style={filterBox}><Field label="Страна"><select className="input" value={country} onChange={e=>{setCountry(e.target.value);setRegion("Все");setCity("Все");setDistrictFilter("Все");setNeighborhoodFilter("Все");}}>{countries.map(x=><option key={x}>{x}</option>)}</select></Field></div>
        <div style={filterBox}><Field label="Область / регион"><select className="input" value={region} onChange={e=>setRegion(e.target.value)}>{regions.map(x=><option key={x}>{x}</option>)}</select></Field></div>
        <div style={filterBox}><Field label="Город"><select className="input" value={city} onChange={e=>{setCity(e.target.value);setDistrictFilter("Все");setNeighborhoodFilter("Все");}}>{cities.map(x=><option key={x}>{x}</option>)}</select></Field></div>
        <div style={filterBox}><Field label={country==="Украина"&&city==="Одесса"?"Официальный район":"Район / district"}><select className="input" value={districtFilter} onChange={e=>setDistrictFilter(e.target.value)}>{districtsMarket.map(x=><option key={x}>{x}</option>)}</select></Field></div>
        <div style={filterBox}><Field label="Локация / микрорайон"><select className="input" value={neighborhoodFilter} onChange={e=>setNeighborhoodFilter(e.target.value)}>{neighborhoods.map(x=><option key={x}>{x}</option>)}</select></Field></div>
    ...
    <div className="card" style={{padding:22,borderRadius:24}}>
      <div className="row"><section><h3 style={{margin:0}}>Источники</h3><p className="muted" style={{margin:"5px 0 0"}}>Можно выбрать сразу несколько площадок. Страна источника фильтруется отдельно от географии объектов.</p></section><div style={{minWidth:240}}><select className="input" value={sourceCountryFilter} onChange={e=>setSourceCountryFilter(e.target.value)}>{catalogSourceCountries.map(x=><option key={x}>{x}</option>)}</select></div></div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(230px,1fr))",gap:10,marginTop:16}}>
        {sourceCatalogVisible.map(item=>{const checked=selectedSources.includes(item.name),count=sourceDataCounts[item.name]||0,connected=connectedSources.has(item.name)||item.name==="CRM";return <div key={`${item.country}-${item.name}`} style={{padding:13,borderRadius:16,border:`1px solid ${checked?"var(--accent)":"rgba(148,163,184,.28)"}`,background:checked?"color-mix(in srgb,var(--accent) 9%,var(--card))":"var(--card)"}}>
          <label style={{display:"flex",gap:10,alignItems:"flex-start",cursor:"pointer"}}><input type="checkbox" checked={checked} onChange={()=>toggleSourceFilter(item.name)} style={{marginTop:3}}/><span style={{flex:1}}><b>{item.name}</b><small style={{display:"block",opacity:.62,marginTop:3}}>{item.country} · {count?`${count} объявл.`:connected?"подключён":"в каталоге"}</small></span></label>
          {!connected&&item.url&&<Button variant="soft" className="full" style={{marginTop:9,minHeight:36,padding:"7px 10px"}} onClick={()=>connectCatalogSource(item)}>＋ Подключить</Button>}
        </div>})}
      </div>
      <div className="row" style={{marginTop:14}}><span className="muted">Если ничего не отмечено — показываются все источники.</span>{selectedSources.length>0&&<Button variant="soft" onClick={()=>setSelectedSources([])}>Очистить выбор ({selectedSources.length})</Button>}</div>
    </div>

    <div className="stats" style={{marginBottom:16}}>
      <div className="stat" style={{minHeight:110}}><span>НАЙДЕНО</span><b style={{fontSize:34}}>{filtered.length}</b></div>
      <div className="stat" style={{minHeight:110}}><span>СРЕДНЯЯ ЦЕНА</span><b style={{fontSize:28}}>{avgPrice?money(avgPrice):"—"}</b></div>
      <div className="stat" style={{minHeight:110}}><span>СРЕДНЯЯ ЦЕНА / М²</span><b style={{fontSize:28}}>{avgM2?money(avgM2):"—"}</b></div>
    ...
    <div className="grid2" style={{marginBottom:16}}>
      <div className="card" style={{padding:22,borderRadius:24}}><div className="row"><section><h3 style={{margin:0}}>Динамика средней цены</h3><p className="muted">Последние доступные дни в выбранном периоде</p></section><span className={cn("badge",changePct<=0?"gold":"")}>{changePct>0?"+":""}{changePct}%</span></div>
        {trend.length?<div style={{height:220,display:"flex",alignItems:"end",gap:8,paddingTop:20}}>{trend.map(x=><div key={x.date} title={`${x.date}: ${money(x.avg)}`} style={{flex:1,minWidth:8,height:`${Math.max(8,(x.avg/trendMax)*180)}px`,borderRadius:"8px 8px 3px 3px",background:"linear-gradient(180deg,var(--accent2),var(--accent))",position:"relative"}}><span style={{position:"absolute",bottom:-24,left:"50%",transform:"translateX(-50%)",fontSize:9,opacity:.65,whiteSpace:"nowrap"}}>{x.date.slice(5)}</span></div>)}</div>:<p className="muted">Недостаточно данных для графика.</p>}
      </div>
    ...
    <div className="card amber" style={{padding:24,borderRadius:24,marginBottom:16}}><div className="row"><section><div style={{fontSize:12,fontWeight:900,letterSpacing:1.5,opacity:.65}}>AI MARKET SUMMARY</div><h3 style={{margin:"6px 0"}}>✦ Автоматический обзор рынка</h3></section><span className="badge gold">{filtered.length} объектов</span></div><p style={{fontSize:16,lineHeight:1.65,marginBottom:0}}>За выбранный период в выборке <b>{filtered.length}</b> объектов. Средняя цена — <b>{avgPrice?money(avgPrice):"не рассчитана"}</b>, средняя цена за м² — <b>{avgM2?money(avgM2):"не рассчитана"}</b>. {trend.length>1?<>Средняя цена изменилась на <b>{changePct>0?"+":""}{changePct}%</b>. </>:null}Больше всего предложений сейчас в локации <b>{topDistrict}</b>. Объектов минимум на 10% дешевле средней цены: <b>{bargainCount}</b>.</p></div>
    ...
    <div className="row" style={{margin:"20px 0 10px"}}><section><h3 style={{margin:0}}>Объявления рынка</h3><p className="muted">{loadingMarket?"Загрузка…":`Показано ${filtered.length} из ${normalizedListings.length}`}</p></section></div>
...
function MarketTools({lang,currentProfile,properties=[]}){
  ...
  async function persistSource(row){
    ...
    const connectionMethod=sourceType==="TELEGRAM"
      ? "TELEGRAM"
      : ["API","XML","RSS","CSV"].includes(sourceType)
        ? sourceType
        : "MANUAL";
  ...
  return <div className="layout" data-theme={theme} style={themeStyle(theme)}><style>{globalThemeCss(theme)}</style>
    ...
    <div className="mainWrap">
      <main className="main">
        ...
        {page==="analytics"&&<Analytics leads={visibleLeads} properties={properties} events={visibleEvents} role={role} users={users} activities={activities} currentProfile={currentProfile} onOpenProperty={setProperty} agencyName={agencyName} theme={theme}/>} 
        {page==="tools"&&<MarketTools lang={lang} currentProfile={currentProfile} properties={properties}/>} 
